...
public static class SharedHttpClient
{
    ...
    static SharedHttpClient()
    {
        ...
        {
            Timeout = Timeout.InfiniteTimeSpan // таймаут управляем через CancellationToken в каждом запросе
        };
 
        Client.DefaultRequestHeaders.UserAgent.ParseAdd("ZxInfoBot/1.0");
        // Client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
        // ConnectionClose = true — НЕ ставим, это убивает переиспользование соединений
    }
}